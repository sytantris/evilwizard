...
# from http://kavassalis.com/2013/04/unicorn-hot-restarts-my-definitive-guide/

# assumes you're in the rails root
...
if [ ! -f "config.ru" ]; then
  echo "[ERROR] You need to run this from the rails root"
  exit 1
fi
